listPage.ListCollectionView = (function () {

    var options = {
        viewType : listPage.ListItemView,
        idPrefix : 'list-item-'
    };

    var ListCollectionView = function () {

    };

    ListCollectionView.prototype = $.extend(new ccwx.CollectionView(options), {
